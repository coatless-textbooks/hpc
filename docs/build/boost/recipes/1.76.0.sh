...
BOOST_URL=https://boostorg.jfrog.io/artifactory/main/release/$BOOST_VERSION_NUMBER/source/$BOOST_TAR
...
# Compile
./b2 --prefix=${BOOST_DIR} -j 26 install
